...
export function Sidebar() {
  ...
  return (
    <nav className="bg-card text-sm rounded-md">
          ...
          <li key={index} className="flex flex-col">
            <div className="flex gap-2 items-center">
              <button
                ...
                className="w-full text-left px-2 py-2 hover:bg-hover transition duration-300 ease-in-out rounded flex gap-2 items-center"
              >
